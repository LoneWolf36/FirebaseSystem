...
//        Bundle b=in.getExtras();
        sp=getSharedPreferences("City_info",Context.MODE_PRIVATE);
          path=sp.getString("City","invalid");
          Log.d("nav_city",path);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
//            Bundle b=new Bundle();
//            b.putString("city",path);
//            Add_schedule ps=new Add_schedule();
//            ps.setArguments(b);
